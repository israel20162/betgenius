...
function Features() {
    return (
        <div className='flex md:gap-28 flex-col md:mt-28'>
            <section id='about' className="flex flex-col md:flex-row items-start w-full   p-4 md:p-8  text-white md:h-screen ">
            ...
            <section id='features' className="flex flex-col md:flex-row items-center w-full justify-between p-4 md:p-8 md:mt-36 text-white md:h-screen  ">
                {/* Text Section */}
            ...
            <section className="flex flex-col  w-full justify-between p-4 md:p-8  text-white md:h-screen ">
                {/* Text Section */}
                <div className="flex-1 mb-8 md:mb-0 md:mr-8 flex flex-col gap-2 md:w-2/3 ">
            ...
            <section className="flex flex-col md:flex-row items-center w-full justify-between p-4 md:p-8 md:mt-36 text-white md:h-screen ">
                {/* Text Section */}
                <div className="flex-1 mb-8 md:mb-0 md:mr-8 flex flex-col gap-2 md:w-2/3 ">
            ...
            <section id='download' className='flex flex-col justify-center items-center md:h-screen gap-6 md:mb-28 mb-16'>
                ...
                <div className=" flex  max-h-full">
                    <img
                        src={WinTogether}
                        alt="Hero Image"
                        className="md:h-screen md:object-contain"
                    />
                </div>
