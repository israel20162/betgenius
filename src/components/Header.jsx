...
const Header = () => {
    ...
    return (
        <header style={headerStyle} className='relative'>
            ...
            <nav className={`md:flex flex flex-col  md:flex-row md:items-center space-y-24 md:space-y-0 md:space-x-6 absolute z-20 md:relative top-16 left-0 w-full md:w-auto bg-[#101624] pb-4 md:bg-transparent md:top-auto md:left-auto ${isOpen ? 'block' : 'hidden'}`}
            >
                <div className='flex flex-col  md:flex-row md:items-center whitespace-nowrap'>
                    <a style={linkStyle}  onClick={toggleMenu} href="#hero">Home</a>
                    <a style={linkStyle}  onClick={toggleMenu} href="#about">About Us</a>
                ...
                <div className='w-full flex justify-center flex-col md:flex-row items-center gap-2 '>
                    ...
                    <a onClick={toggleMenu} href="#" className='w-11/12 mx-auto md:hidden'>
                        <button className='bg-[#2AFD84] h text-[#101624] px-6 py-2 rounded w-full'>Join Our Telegram</button>
                    </a>
                </div>
            </nav>
        </header>
