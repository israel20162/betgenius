...
function Hero() {
    ...
    return (
        <section  id='hero' className="flex flex-col mt-16 md:flex-row will-change-scroll items-start w-full justify-between p-4  text-white md:h-screen md:my-5">
            {/* Text Section */}
            <div className="flex-1 mb-8 md:mb-0 md:mr-8 flex flex-col gap-2 md:w-2/3 ">
                <h1 className="md:text-4xl text-3xl md:leading-relaxed md:text-wrap font-bold md:mb-4 mb-2">
